...
public class Suspendidos extends javax.swing.JPanel {
    ...
    public Suspendidos() {
        ...
        try {
            ...
            Logger.getLogger(Suspendidos.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        tblReporte.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Planilla ID", "Trabajador ID", "CUI", "Nombre", "Posicion", "Sueldo", "Empresa", "Estado", "Fecha"
            }
        ) {
        ...
        tblReporte.setPreferredSize(new java.awt.Dimension(1160, 400));
