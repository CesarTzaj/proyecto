...
public class SueldoMinimo extends javax.swing.JPanel {
    ...
    public SueldoMinimo() {
        ...
        try {
            ...
            Logger.getLogger(SueldoMinimo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1300, 871));

        container.setBackground(new java.awt.Color(168, 161, 96));
        container.setMinimumSize(new java.awt.Dimension(1010, 40));
        ...
        tblReporte.setForeground(new java.awt.Color(0, 0, 0));
        tblReporte.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Planilla ID", "Trabajador ID", "CUI", "Nombre", "Posicion", "Suedo", "Empresa", "Estado", "Fecha"
            }
        ));
        tblReporte.setEnabled(false);
        tblReporte.setInheritsPopupMenu(true);
        tblReporte.setPreferredSize(new java.awt.Dimension(1140, 400));
        ...
        if (tblReporte.getColumnModel().getColumnCount() > 0) {
            ...
            tblReporte.getColumnModel().getColumn(3).setMinWidth(310);
...
"AND ps.idposicion = pt.posicion_idposicion";
        ...
        try {
            ...
            values[8] = rs.getString("mes")+" / "+rs.getString("anio");
                //JOptionPane.showMessageDialog(this, values[7]);
            model.addRow(values);
            }
